...
for ig in range(ng):
    ...
    #print("here", "id", id, "ig", ig, "nz", nz, "nt", nt, "z", z, "p_i", p_i, 'p', p, 'redchi2', red_chi2, 'full_probs', full_probs)
    if save_full_probs: full_probs[str(id[ig])]=[z,p_i[:nz,:nt],p[:nz,:nt],red_chi2]
    #print("here", id, ig, nz, nt, z, p_i, p, red_chi2, full_probs)	
