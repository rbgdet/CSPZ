...
df = pd.read_csv('/project/chihway/raulteixeira/data/BalrogOfTheDECADE_20231002/catbalrog_52.csv.gz')
...
filename = "%s/som_BalrogOfTheDECADE_20231002_26x26_52.npz"%(outpath)
