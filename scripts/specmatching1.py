...
# Open catalogs
data_df = get_dataframes(filenames[:10])
...
data_df_spec.to_csv('/home/raulteixeira/scratch-midway2/CosmicShearData/DELVE_BDF_data_with_zspec022123_1.csv.gz', sep=',', header=True, index=False)
print('done')