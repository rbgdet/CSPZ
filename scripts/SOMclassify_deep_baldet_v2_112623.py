...
som_weights = np.load("%s/som_weights_des_DF_balrog_pass_gold+wl+fg_48x48_112523.npy"%outpath)
...
filename = "%s/som_DES_DF_balrog_gold+wl+fg_112623_48x48.npz"%(outpath)
