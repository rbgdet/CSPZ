...
np.random.seed(42)
som_deep.fit(deep_n_input, epochs=5)
pred = som_deep.predict(deep_n_input)

deep_weights = som_deep.weights
print(deep_weights.shape)

np.savetxt('/project2/chihway/raulteixeira/data/deepfields_weights_5E_UV.txt', deep_weights)
...
specz.to_csv('/project2/chihway/raulteixeira/data/deepfields_specz_SOMpred_5E_UV.csv.gz')