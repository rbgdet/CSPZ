...
with h5py.File('/project/chihway/data/decade/metacal_gold_combined_20230919.hdf') as f:
    ...
    np.save('/project/chihway/raulteixeira/data/DR3_1_2_metacal_gold_mask.npy', Mask)
