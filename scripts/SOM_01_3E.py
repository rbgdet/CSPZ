...
np.random.seed(42)
som_deep.fit(deep_n_input, epochs=3)
pred = som_deep.predict(deep_n_input)

deep_weights = som_deep.weights
print(deep_weights.shape)

np.savetxt('/project2/chihway/raulteixeira/data/deepfields_weights_3E_01.txt', deep_weights)
...
specz.to_csv('/project2/chihway/raulteixeira/data/deepfields_specz_SOMpred_3E_01.csv.gz')