...
wide = pd.read_hdf(f"%s/classify_sfd98_1p/som_metacal_all_gold_wide_32x32_full.hdf5"%outpath, key='df')
...
wide[['id', 'TomoBin']].to_hdf('%s/classify_sfd98_1p/DR3_1_ID+TomoBin.hdf5'%outpath, key='df')