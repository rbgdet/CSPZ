...
np.savetxt('/project2/chihway/raulteixeira/data/deepfields_weights_10E_UV.txt', deep_weights)
...
specz.to_csv('/project2/chihway/raulteixeira/data/deepfields_specz_SOMpred_10E_UV.csv.gz')