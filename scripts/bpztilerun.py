...
list_lines = ['COLUMNS     /home/raulteixeira/photoz/code/software/DESC_BPZ/tests/CosmicShearPZ.columns\n'
              , f'OUTPUT\t    /home/raulteixeira/scratch-midway2/CosmicShearData/bpztiles/output/pzs/pz_sgY3_{tile}_finer_test.h5\n'
              , 'SPECTRA     CWWSB4.list\n', 'PRIOR\t  hdfn_gen\n', 'DZ          0.01\n', 'ZMIN        0.005\n'
...
sp.run(['python', '/home/raulteixeira/repos/DESC_BPZ/scripts/bpz.py', catalog_name, '-P', '/home/raulteixeira/photoz/code/software/DESC_BPZ/tests/DELVEdata_example.pars'], capture_output=False)
