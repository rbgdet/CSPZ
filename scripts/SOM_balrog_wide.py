...
#df = pd.read_csv('/project/chihway/raulteixeira/data/BalorgOfTheDECADE_v01_29072023_DET.csv.gz')
df = pd.read_csv('/project/chihway/raulteixeira/data/BalorgOfTheDECADE_v01_29072023.csv.gz')

flux_r, flux_i, flux_z = df['FLUX_r'].values, df['FLUX_i'].values, df['FLUX_z'].values
flux_err_r, flux_err_i, flux_err_z = df['FLUX_r_ERR'].values, df['FLUX_i_ERR'].values, df['FLUX_z_ERR'].values
...
filename = "%s/som_balrog_wide_v01_29072023_26x26.npz"%(outpath)
