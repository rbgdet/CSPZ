...
flux_r, flux_i, flux_z = df['mcal_flux_r_noshear'].values, df['mcal_flux_i_noshear'].values, df['mcal_flux_z_noshear'].values

flux_err_r, flux_err_i, flux_err_z = df['mcal_flux_r_err_noshear'].values, df['mcal_flux_i_err_noshear'].values, df['mcal_flux_z_err_noshear'].values
